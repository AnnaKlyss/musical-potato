...
Создание нового файла в репозитории с названием .gitignore, позволит игнорировать файлы не добавленные в репозиторий. Для этого необходимо прописать в .gitinore  имя файла(изображения).
...
Дляя слияния веток необходимо перейти в ту ветку, которая иявляется основной и написать команду  
* git merge <имя ветки>
